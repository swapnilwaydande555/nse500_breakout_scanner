...
def send_test_alert(msg):
    # Minimal non-blocking test wrapper. If token not set, return message.
    ...
    # If tokens are set, attempt to call Telegram sendMessage (requests) - here we return the URL for safety.
